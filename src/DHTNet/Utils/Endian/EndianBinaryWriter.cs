...
namespace DHTNet.Utils.Endian
{
    ...
    public class EndianBinaryWriter : IDisposable
    {
        ...
        public EndianBinaryWriter(EndianBitConverter bitConverter,
            Stream stream, bool leaveOpen = false) : this(bitConverter, stream, Encoding.UTF8, leaveOpen)
        {
        }
        ...
        public EndianBinaryWriter(EndianBitConverter bitConverter, Stream stream, Encoding encoding, bool leaveOpen = false)
        {
