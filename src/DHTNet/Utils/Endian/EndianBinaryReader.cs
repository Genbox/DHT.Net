...
namespace DHTNet.Utils.Endian
{
    ...
    public class EndianBinaryReader : IDisposable
    {
        ...
        public EndianBinaryReader(EndianBitConverter bitConverter, Stream stream, bool leaveOpen = false) : this(bitConverter, stream, Encoding.UTF8, leaveOpen)
        {
        }
        ...
        public EndianBinaryReader(EndianBitConverter bitConverter, Stream stream, Encoding encoding, bool leaveOpen = false)
        {
